...
FLAGS        = -std=c++14 -Imodified_porechop/include -fPIC
LDFLAGS      = -shared
...
TARGET       = modified_porechop/cpp_functions.so
SHELL        = /bin/sh
SOURCES      = $(shell find modified_porechop -name "*.cpp")
HEADERS      = $(shell find modified_porechop -name "*.h")
