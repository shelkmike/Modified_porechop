...
exec(open('modified_porechop/version.py').read())
...
class PorechopInstall(install):
    ...
    def run(self):
        ...
        shutil.copyfile(os.path.join('modified_porechop', 'cpp_functions.so'),
                        os.path.join(self.install_lib, 'modified_porechop', 'cpp_functions.so'))
...
setup(name='modified_porechop',
      version=__version__,
      description='modified_porechop',
      long_description=LONG_DESCRIPTION,
      url='http://github.com/shelkmike/modified_porechop',
      author='Mikhail Schelkunov. Original Porechop created by Ryan Wick',
      author_email='shelkmike@gmail.com',
      license='GPL',
      packages=['modified_porechop'],
      entry_points={"console_scripts": ['modified_porechop = modified_porechop.modified_porechop:main']},
      zip_safe=False,
